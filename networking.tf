...
resource "aws_vpc" "main" {
  ...
  tags = {
    Name = "${var.business_divsion}-${var.environment}-main_vpc"
  }
}
...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "${var.business_divsion}-${var.environment}-public_subnet-${count.index}"
  }
}
...
resource "aws_internet_gateway" "igw" {
  ...
  tags = {
    Name = "${var.business_divsion}-${var.environment}-main_igw"
  }
}
...
resource "aws_route_table" "rtb-public" {
  ...
  tags = {
    Name = "${var.business_divsion}-${var.environment}-Public-RT"
  }
}
...
resource "aws_subnet" "private" {
  ...
  tags = {
    Name = "${var.business_divsion}-${var.environment}-private_subnet-${count.index}"
  }
}
...
resource "aws_nat_gateway" "ngw" {
  ...
  tags = {
    Name = "${var.business_divsion}-${var.environment}-gw NAT"
  }
}
